...
const ROOM_CONNECTIONS: Record<string, string[]> = {
  ...
  'BILLIARD_ROOM': ['HALL_BILLIARD', 'LIBRARY_BILLIARD', 'BILLIARD_DINING', 'BILLIARD_BALLROOM'],
  'DINING_ROOM': ['LOUNGE_DINING', 'BILLIARD_DINING', 'DINING_KITCHEN'],
  ...
  'HALL_BILLIARD': ['HALL', 'BILLIARD_ROOM'],
  'LOUNGE_DINING': ['LOUNGE', 'DINING_ROOM'],
  'LIBRARY_BILLIARD': ['LIBRARY', 'BILLIARD_ROOM'],
  'BILLIARD_DINING': ['BILLIARD_ROOM', 'DINING_ROOM'],
  'LIBRARY_CONSERVATORY': ['LIBRARY', 'CONSERVATORY'],
  'BILLIARD_BALLROOM': ['BILLIARD_ROOM', 'BALLROOM'],
  'DINING_KITCHEN': ['DINING_ROOM', 'KITCHEN'],
...
const ROOMS = [
  'STUDY', 'HALL', 'LOUNGE', 'LIBRARY', 'BILLIARD_ROOM',
  'DINING_ROOM', 'CONSERVATORY', 'BALLROOM', 'KITCHEN'
];
